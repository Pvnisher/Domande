...
=======
    ...
    file << "else{\ndocument.getElementById('rand').value=\"rand attivo\";\nrand=true;}}\n</script>\n";
    //css e chiudo head
    file << "<style>.container {height:85%; max-height:85%; display: inline-block; overflow: scroll; width: 100%;}.domanda{font-weight: bold;}.sdrogo{width: 80%; display:none;}</style></head>";
    //bottoni
    file << "<body onload='start()'>";
    file << "<input type=button id='nascondimostra' style='position:fixed; margin-left: 85%' onclick=\"w3.toggleShow('.risposta')\" value='Mostra/nascondi riposte'>";
